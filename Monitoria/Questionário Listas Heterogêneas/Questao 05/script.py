# esse literal foi meu trabalho de APC
# apenas fiz algumas mudanças, por isso o código ta bem mal otimizado
# caso queira ver uma versao mais bonita, va no meu 2 semestre, Projetos, Projeto 0
...
def printaGrade(lista):
    ...
    for chave in dic_horarios:
        if dic_horarios[chave][16:] != "|          |          |          |          |          |          |":
            g_horaria.append(dic_horarios[chave])
