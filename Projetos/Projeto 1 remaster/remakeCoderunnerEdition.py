"""
Alteracoes feitas:
- O espacamento agora é SEMPRE 10, o que literalmente tira a modularidade toda do meu programa.
- Removi o domingo.
"""
...
def printa_grade(grade,espacamento):
    ...
    espaco = " "*espacamento + "|"
    horarios = {
    "M1":{0:"| 08:00 - 08:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "M2":{0:"| 08:55 - 09:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "M3":{0:"| 10:00 - 10:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "M4":{0:"| 10:55 - 11:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "M5":{0:"| 12:00 - 12:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T1":{0:"| 12:55 - 13:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T2":{0:"| 14:00 - 14:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T3":{0:"| 14:55 - 15:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T4":{0:"| 16:00 - 16:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T5":{0:"| 16:55 - 17:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "T6":{0:"| 18:00 - 18:55 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "N1":{0:"| 19:00 - 19:50 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "N2":{0:"| 19:50 - 20:40 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "N3":{0:"| 20:50 - 21:40 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco},
    "N4":{0:"| 21:40 - 22:30 |",1:espaco,2:espaco,3:espaco,4:espaco,5:espaco,6:espaco}
    }
    ...
    for chave in grade:
        ...
        tam_str = len(codigo)
        espacos = " "*(int((espacamento-tam_str)/2))
        
        # modificando o horario
        horarios[turno][int(chave[0])-1] = espacos + codigo + espacos + "|"
    
    # printando a grade
    for turno in horarios:
        mudou = verificaMudou(horarios[turno])
        if mudou:
            for i in range(0,7):
